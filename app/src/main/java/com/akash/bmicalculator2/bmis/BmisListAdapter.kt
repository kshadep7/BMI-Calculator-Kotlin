...
import com.akash.bmicalculator2.databinding.BmiItemBinding
import com.akash.bmicalculator2.models.BMI


class BmisListAdapter(private val viewModel: BmisViewModel) :
    ListAdapter<BMI, BmisListAdapter.BmiViewHolder>(BmiDiffCallback()) {

    class BmiViewHolder private constructor(val binding: BmiItemBinding) :
